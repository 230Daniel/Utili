...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.AutopurgeConfiguration", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.AutopurgeMessage", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.ChannelMirroringConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.CoreConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.InactiveRoleConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.InactiveRoleMember", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.JoinMessageConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.JoinRolesConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.JoinRolesPendingMember", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.MessageFilterConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.MessageLogsConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.MessageLogsMessage", b =>
                {
                    b.Property<decimal>("MessageId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("message_id");
            ...
            modelBuilder.Entity("Database.Entities.MessagePinningConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.MessagePinningWebhook", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.NoticeConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.PremiumSlot", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.ReputationConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.ReputationConfigurationEmoji", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.ReputationMember", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.RoleLinkingConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.RolePersistConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.RolePersistMember", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.ShardDetail", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.Subscription", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.VoiceLinkChannel", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.VoiceLinkConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.VoiceRoleConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.VoteChannelConfiguration", b =>
                {
                    b.Property<decimal>("GuildId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("guild_id");
            ...
            modelBuilder.Entity("Database.Entities.ReputationConfigurationEmoji", b =>
                {
                    b.HasOne("Database.Entities.ReputationConfiguration", null)
                        .WithMany("Emojis")
