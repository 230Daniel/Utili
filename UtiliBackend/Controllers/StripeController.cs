...
using UtiliBackend.Models.Stripe;
using CustomerService = UtiliBackend.Services.CustomerService;
...
namespace UtiliBackend.Controllers
{
    ...
    public class StripeController : Controller
    {
        ...
        public StripeController(IConfiguration configuration, CustomerService customerService, StripeClient stripeClient)
        {
